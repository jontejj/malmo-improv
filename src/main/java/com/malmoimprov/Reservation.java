...
public class Reservation implements Serializable
{
	...
	@Min(1) @Max(5) private Integer nrOfSeats;

	@Index private Boolean paid = false;

	@Index(IfDefault.class) private Boolean sentConfirmationAboutEvent = false;

	@Index private Boolean cancelled = false;

	@Index(IfDefault.class) private Boolean sentReminderAboutEvent = false;

	@Index private Long eventId;
